...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
    ...
    cnn1 = tf.keras.layers.Conv1D(256, 3, padding='same', strides=1, activation='relu')(output_layer)
    cnn1 = tf.keras.layers.MaxPooling1D(pool_size=10)(cnn1)
    cnn2 = tf.keras.layers.Conv1D(256, 4, padding='same', strides=1, activation='relu')(output_layer)
    cnn2 = tf.keras.layers.MaxPooling1D(pool_size=10)(cnn2)
    cnn3 = tf.keras.layers.Conv1D(256, 5, padding='same', strides=1, activation='relu')(output_layer)
    ...
    # import pdb
    # pdb.set_trace()
    hidden_size = drop.shape[-1].value
    ...
    with tf.variable_scope("loss"):
        ...
        logits = tf.matmul(drop, output_weights, transpose_b=True)
